...
Create table if not exists kafkamanagementapi.registerusers(userid text,pwd text,team text,roleid text,fullname text, mailid text,status text,registeredtime timestamp, approver text, PRIMARY KEY(userid));
